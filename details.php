                  ...
                  <div class="col-md-9"><!-- col-md-9 Begin -->
                      <div id="productMain" class="row"><!-- row Begin -->
                          ...
                          <div class="col-sm-6"><!-- col-sm-6 Begin -->
                              <div class="box"><!-- box Begin -->
                                  <h1 class="text-center">M dev Polo</h1>
                                  
                                  <form action="detail.php" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                      ...
                                      <div class="form-group"><!-- form-group Finish -->
                              ...
                              <div class="row" id="thumbs"><!-- row Begin -->
                                  ...
                                  <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                      <a href="#" class="thumb"><!-- thumb Begin -->
                                          <img data-target="#myCarousel" data-slide-to="0" src="admin_area/product_images/product-1.jpg" alt="product-1" class="img-responsive">
                                      </a><!-- thumb Finish -->
                                  </div><!-- col-xs-4 Finish -->
                                  
                                  <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                      <a href="#" class="thumb"><!-- thumb Begin -->
                                          <img data-target="#myCarousel" data-slide-to="1" src="admin_area/product_images/product-2.jpg" alt="product-2" class="img-responsive">
                                      </a><!-- thumb Finish -->
                                  </div><!-- col-xs-4 Finish -->
                                  
                                  <div class="col-xs-4"><!-- col-xs-4 Begin -->
                                      <a href="#" class="thumb"><!-- thumb Begin -->
                                          <img data-target="#myCarousel" data-slide-to="2" src="admin_area/product_images/product-3.jpg" alt="product-3" class="img-responsive">
                                      </a><!-- thumb Finish -->
                                  </div><!-- col-xs-4 Finish -->
                      ...
                      <div class="box" id="details"><!-- box Begin -->
                          ...
                          <p>
                              ...
                              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error quaerat consequuntur nesciunt alias numquam doloribus, fuga unde quam debitis, quas, possimus reprehenderit eligendi blanditiis quod accusantium fugit laborum ipsa perspiciatis.
